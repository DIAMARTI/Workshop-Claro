...
[developer@podman ~]$ wget ftp://classroom.opennova.pe/openshift/podman/sample.sql
[developer@podman ~]$ podman cp ~/sample.sql mysql-server:/tmp
[developer@podman ~]$ podman exec -it -l /bin/bash

bash-4.2$ mysql -uuser9 -predhat samples < sample.sql
...
[developer@podman ~]$ mysql -uuser9 -predhat -h127.0.0.1 -P 13306 samples < sample.sql
[developer@podman ~]$ mysql -uuser9 -predhat -h127.0.0.1 -P 13306 samples -e "use samples; select * from Items;"
[developer@podman ~]$ podman unshare ls -l /home/developer/mysql/data/*
