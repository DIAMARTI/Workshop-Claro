...
```
# poddman login registry.redhat.io
# username: <user>
# password: <pass>
# podman run --name httpd-root -d -p 80:8080 -p 443:8443 registry.redhat.io/rhel8/httpd-24
# podman port -l
# podman inspect httpd-server | grep -E '(IPAddress|expose)'
# curl http://localhost
